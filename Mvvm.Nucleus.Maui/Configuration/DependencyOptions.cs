...
public class DependencyOptions
{
    ...
    /// These Views can be pushed on any NavigationStack. For Views present in AppShell.xaml see <see cref="RegisterShellView{TView, TViewModel}(string, ViewScope)"/>.
    /// </summary>
    ...
    /// <param name="registrationScope">The <see cref="ViewScope"/> to be used.</param>
    ...
    /// For Views not present in AppShell.xaml see <see cref="RegisterView{TView, TViewModel}(string?, ViewScope)"/>.
    /// </summary>
    /// <typeparam name="TView">The <see cref="Type"/> of the View.</typeparam>
    /// <typeparam name="TViewModel">The <see cref="Type"/> of the ViewModel.</typeparam>
