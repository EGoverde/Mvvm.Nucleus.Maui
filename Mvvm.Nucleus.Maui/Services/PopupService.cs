...
public class PopupService : IPopupService
{
    ...
    public PopupService(NucleusMvvmOptions nucleusMvvmOptions, ILogger<PopupService> logger, IServiceProvider serviceProvider, CommunityToolkit.Maui.IPopupService popupService)
    {
    ...
    //     void popupOpened(object? sender, EventArgs eventArgs)
    //     {
    ...
    //     void popupClosed(object? sender, EventArgs eventArgs)
    //     {
    ...
    //     return await MainThread.InvokeOnMainThreadAsync(() => currentPage.ShowPopupAsync(popup, token: token));
    // }
