...
- `IPrepareAsync`: Triggered when a page is created, but before it is returned for navigation. It runs asynchronously, but likely finishes earlier than `IInitializable(Async)`.
